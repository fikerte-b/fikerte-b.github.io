...
module.exports = { maxOfThree, sum, multiply, findLongestWord, reverseArray,scoreExams, generateArray }; //add all of your function names here that you need for the node mocha tests
*/
/**
 * 
